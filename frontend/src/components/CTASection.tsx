      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl md:text-2xl text-green-100 max-w-3xl mx-auto leading-relaxed">
            Join thousands of farmers, buyers, and suppliers who are already growing their 
            businesses with Kenya's premier agri-commerce platform.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300">
            ...
            <p className="text-green-100 mb-4">Sell direct to customers and earn more from your harvest</p>
            <Button variant="outline" className="border-white text-white hover:bg-white hover:text-[#2D5A27]">
              Register as Farmer
            </Button>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300">
            ...
            <p className="text-green-100 mb-4">Get fresh produce directly from verified farmers</p>
            <Button variant="outline" className="border-white text-white hover:bg-white hover:text-[#2D5A27]">
              Start Buying
            </Button>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300">
            ...
            <p className="text-green-100 mb-4">Connect your agricultural inputs with farmers nationwide</p>
            <Button variant="outline" className="border-white text-white hover:bg-white hover:text-[#2D5A27]">
              Become Supplier
            </Button>
          </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold mb-2">Call Our Support Team</h4>
              <p className="text-green-100 mb-4">Speak with our agricultural experts in Kiswahili or English</p>
              <a href="tel:+254700123456" className="text-[#FF8C42] font-semibold hover:underline">
                +254 700 123 456
              </a>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold mb-2">Download User Guide</h4>
              <p className="text-green-100 mb-4">Step-by-step guide in Kiswahili and English</p>
